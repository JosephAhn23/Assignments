...
public class RandomGenerator {
	...
	public static Car generateRandomCar(int plateLength) {
		if (plateLength <= 0) {
			throw new IllegalArgumentException("Plate length must be a positive integer");
		}
		
		String plateNumber = generateRandomString(plateLength);
